const History = () => {
  return (
    <>
    <div id='history' className="p-6 bg-gray-50 dark:bg-slate-900 mt-2 rounded-lg **shadow-md**">
      <h2 className="text-2xl font-bold mb-6 text-green-800 dark:text-green-400 text-center">History of CSTD</h2>

      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow hover:shadow-md transition-transform duration-300 transform hover:scale-105">
          <h3 className="text-lg font-semibold mb-2 text-green-800 dark:text-green-400">Establishment</h3>
        ...
        <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow hover:shadow-md transition-transform duration-300 transform hover:scale-105">
          <h3 className="text-lg font-semibold mb-2 text-green-800 dark:text-green-400">Milestones</h3>
          <p className="text-sm text-gray-700 dark:text-slate-300 leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow hover:shadow-md transition-transform duration-300 transform hover:scale-105">
          <h3 className="text-lg font-semibold mb-2 text-green-800 dark:text-green-400">Development Impact</h3>
          <p className="text-sm text-gray-700 dark:text-slate-300 leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow hover:shadow-md transition-transform duration-300 transform hover:scale-105">
          <h3 className="text-lg font-semibold mb-2 text-green-800 dark:text-green-400">Global Outlook</h3>
          <p className="text-sm text-gray-700 dark:text-slate-300 leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow hover:shadow-md transition-transform duration-300 transform hover:scale-105">
          <h3 className="text-lg font-semibold mb-2 text-green-800 dark:text-green-400">Strategic Planning</h3>
          <p className="text-sm text-gray-700 dark:text-slate-300 leading-relaxed">
