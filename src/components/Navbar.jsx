      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8 items-center text-md">
            ...
            <Dropdown label="About Us" page="/#" items={["Mission & Vision", "Leadership", "History"]} />
            <Dropdown label="Satellite Missions" page="https://central.nasrda.gov.ng/space-missions/" items={["Past Missions", "Ongoing Projects", "Upcoming Launches"]} />
